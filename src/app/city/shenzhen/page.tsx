...
const NAME = "深圳";
const TITLE = "深圳AHA急救培训-HeartSaver急救员认证课程";
const DESC =
  "深圳AHA急救培训，美国心脏协会HeartSaver急救员认证，CPR心肺复苏、AED使用。深圳两地可选：南山区/福田区，培训地址：深圳市南山区新西路9号兰光科技园C栋603A。证书全球通用。";

export const metadata: Metadata = {
  title: TITLE,
  description: DESC,
  alternates: { canonical: `${SITE_URL}/city/shenzhen` },
  openGraph: { title: TITLE, description: DESC, url: `${SITE_URL}/city/shenzhen` },
};
...
export default function ShenzhenCityPage() {
  return (
    <div className="min-h-screen bg-white">
      <article className="max-w-2xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        ...
        <section className={SECTION_CLASS}>
          ...
          <address className="text-neutral-700 not-italic mb-2">
