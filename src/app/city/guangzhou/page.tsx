...
const NAME = "广州";
const TITLE = "广州AHA急救培训-HeartSaver急救员认证课程";
const DESC =
  "广州AHA急救培训，美国心脏协会HeartSaver急救员认证，CPR心肺复苏、AED使用。培训地址：广州市荔湾区南岸路63号城启大厦513室。证书全球通用。";

export const metadata: Metadata = {
  title: TITLE,
  description: DESC,
  alternates: { canonical: `${SITE_URL}/city/guangzhou` },
  openGraph: { title: TITLE, description: DESC, url: `${SITE_URL}/city/guangzhou` },
};
...
export default function GuangzhouCityPage() {
  return (
