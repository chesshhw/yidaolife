...
export const metadata: Metadata = {
  title: TITLE,
  description: DESC,
  alternates: { canonical: `${SITE_URL}/city/beijing` },
  openGraph: { title: TITLE, description: DESC, url: `${SITE_URL}/city/beijing` },
};
    ...
    <div className="min-h-screen bg-white">
      <article className="max-w-2xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        ...
        <h1 className="text-xl sm:text-2xl font-semibold text-neutral-900 mb-6">
          北京AHA急救培训｜HeartSaver急救员认证课程
        </h1>

        {/* 开篇两段 */}
        <section className={SECTION_CLASS}>
          <p className={P_SHORT}>
            在北京参加美国心脏协会（AHA）HeartSaver急救员认证课程，是目前北京地区广受认可的国际急救培训项目。
        ...
        <section className={SECTION_CLASS}>
          ...
          <dl className="space-y-4">
            ...
            <div>
              <dt className="font-medium text-neutral-900">Q4：北京是否支持企业团训？</dt>
