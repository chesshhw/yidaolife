...
const NAME = "天津";
const TITLE = "天津AHA急救培训-HeartSaver急救员认证课程";
const DESC =
  "天津AHA急救培训，美国心脏协会HeartSaver急救员认证，CPR心肺复苏、AED使用。培训地址：天津市和平区大沽北路与徐州道交口万通中心20层培训教室。证书全球通用。";

export const metadata: Metadata = {
  title: TITLE,
  description: DESC,
  alternates: { canonical: `${SITE_URL}/city/tianjin` },
  openGraph: { title: TITLE, description: DESC, url: `${SITE_URL}/city/tianjin` },
};
...
export default function TianjinCityPage() {
  return (
