...
const NAME = "重庆";
const TITLE = "重庆AHA急救培训-HeartSaver急救员认证课程";
const DESC =
  "重庆AHA急救培训，美国心脏协会HeartSaver急救员认证，CPR心肺复苏、AED使用。培训地址：重庆市渝中区南纪门街道复旦中学飞腾游泳馆。证书全球通用。";

export const metadata: Metadata = {
  title: TITLE,
  description: DESC,
  alternates: { canonical: `${SITE_URL}/city/chongqing` },
  openGraph: { title: TITLE, description: DESC, url: `${SITE_URL}/city/chongqing` },
};
...
export default function ChongqingCityPage() {
  return (
